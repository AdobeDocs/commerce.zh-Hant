...
>[!NOTE]
>
>[!DNL Commerce Storefront on Edge Delivery Services]的[外掛元件](https://experienceleague.adobe.com/en/tools/commerce-storefront/dropins/all/introduction/)會自動擷取最新的GraphQL變更（新欄位、限制和查詢行為）。
...
| 服務 | 店面 |
| --- | --- |
| [AEM Assets整合](../aem-assets-integration/release-notes.md)<br>[Commerce Optimizer聯結器](../aco-connector/release-notes.md) | [店面版本資訊](https://experienceleague.adobe.com/en/tools/commerce-storefront/releases/)<br>[店面變更記錄檔](https://experienceleague.adobe.com/en/tools/commerce-storefront/releases/changelog/) |
