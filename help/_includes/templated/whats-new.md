...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>已發佈一般可用性發行版本的<a href="https://experienceleague.adobe.com/docs/commerce/aco-optimizer-connector/overview.html">Adobe Commerce Optimizer Connector v1.0.9檔案</a>。</p>
</td>
      <td>
        重大更新、新主題、技術
      </td>
