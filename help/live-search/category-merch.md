...
**智慧型排名**&#x200B;利用[Adobe AI](https://business.adobe.com/ai.html)的店面行為資料分析，以特定演演算法排序選定類別中的所有產品。 選擇智慧型排名後，產品的特定順序會隨著時間而改變，因為[!DNL Adobe AI]會持續重新分析基礎資料。 例如，熱門趨勢產品會隨著購物者偏好設定變更而自動隨時間變更。
智慧型排名方法為：
