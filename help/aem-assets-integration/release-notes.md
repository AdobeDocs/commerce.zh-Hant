...
![已修正問題](../assets/fix.svg)<!-- Issue ACAP-1223 -->已修正可設定產品的「管理員」中出現重複的產品影像角色集的問題。

![已修正問題](../assets/fix.svg)<!-- Issue CCSAAS-4769 -->已修正`UpdateAssetImageRolesDataPatch`中在升級或資料修補程式期間導致完整性條件約束違規的問題。
