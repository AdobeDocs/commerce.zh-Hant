...
![新問題](../assets/new.svg)<!-- Issue ACCS-169 --> **[!UICONTROL Program ID]**&#x200B;和&#x200B;**[!UICONTROL Environment ID]**&#x200B;欄位現在會根據使用者的IMS工作階段自動填入為下拉式清單。 如此可免除手動輸入，並減少組態錯誤。 若要使用此功能，使用者必須在[AEM傳遞層](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/onboarding/journey/assign-profiles-aem#add-team-members){target=_blank}中擁有角色，且已設定有效的[資產選擇器IMS使用者端ID](https://experienceleague.adobe.com/en/docs/commerce/aem-assets-integration/get-started/setup-synchronization#configure-the-connection){target=_blank}。
