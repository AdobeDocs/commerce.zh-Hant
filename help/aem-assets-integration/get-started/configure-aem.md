...
* 為您的Commerce執行個體設定的&#x200B;**IMS組織ID**。

* 若要在AEM as a Cloud Service上啟用具有OpenAPI功能的[Dynamic Media](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-cloud-service/content/assets/dynamicmedia/dynamic-media-open-apis/dynamic-media-open-apis-overview#enable-dynamic-media-open-apis)，請使用下列資訊提交Adobe支援票證：
