...
若要在AEM Assets中管理Commerce資產檔案，請完成下列步驟，以使用所需的套件程式碼和中繼資料設定AEM Assets專案，以便從AEM製作環境管理Commerce資產。

## AEM Commerce `assets-commerce`封裝內容
...
1. 從AEM Cloud Manager [部署您的程式碼以更新AEM環境](https://experienceleague.dobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/deploy-code#deploying-code-with-cloud-manager)。
...
如果您遇到任何問題，請依照[支援](../overview.md#support)中所述的步驟操作。
