...
>[!NOTE]
>
> 使用者也必須新增至Commerce和AEM Assets。 如需完整設定，請參閱「[使用者和AEM Assets](https://experienceleague.adobe.com/en/docs/commerce/cloud-service/user-management#add-a-user-to-aem-assets-or-product-visuals){target=_blank}指南」中的&#x200B;_新增使用者至Identity Management或產品視覺效果_。
...
* [將使用者新增至AEM Assets或產品視覺效果](https://experienceleague.adobe.com/en/docs/commerce/cloud-service/user-management#add-a-user-to-aem-assets-or-product-visuals){target=_blank} — 針對ACCS，請先將使用者新增至Commerce和AEM Cloud Manager （業務負責人、部署管理員）。 **AEM Assets DM OpenAPI使用者 — 傳遞**&#x200B;設定檔（或作為遞補的&#x200B;**作者**&#x200B;設定檔）是「資產選擇器」和自動填入功能的額外需求。
