...
在您[將應用程式](https://experienceleague.adobe.com/zh-hant/docs/commerce/app-management/manage-app/manage-app)與您的Commerce執行個體建立關聯，並從應用程式完成任何設定指示之後，webhook行為會遵循應用程式的實作。
