...
適用於Adobe Developer App Builder[的](https://developer.adobe.com/graphql-mesh-gateway/gateway/overview/)API Mesh可讓開發人員使用Adobe I/O Runtime將私人或協力廠商API和其他介面與Adobe產品整合。
...
1. 依照[API Mesh開發人員指南](https://developer.adobe.com/graphql-mesh-gateway/gateway/create-mesh/)中的&#x200B;_建立Mesh_&#x200B;的指示，將API Mesh連線至您的Adobe Commerce執行個體。
...
1. 使用`CommerceCatalogServiceGraph`Adobe I/O可擴充CLI[將](https://developer.adobe.com/graphql-mesh-gateway/mesh/basic/#install-the-aio-cli)來源新增至您的網格。
