...
若要最佳化轉換和收入，請實作有效的&#x200B;**搜尋規則**、強大的&#x200B;**預設清單**&#x200B;規則和&#x200B;**[類別規則](add.md#category-rules)** （測試版）。 使用銷售資料、庫存、促銷活動和[智慧型排名](add.md#intelligent-ranking)調整排名。
...
- 在高流量或高利潤的[類別頁面](add.md#category-rules)上使用&#x200B;**類別規則**，其中已組織的訂單與搜尋一樣重要，例如，季節性系列或精選部門。
