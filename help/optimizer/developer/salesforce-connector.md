...
如需端對端影片教學課程系列，請參閱[瞭解Salesforce Commerce雲端入門套件](https://experienceleague.adobe.com/en/docs/commerce-learn/adobe-commerce-optimizer/sfcc-starter-kit/overview)。

>[!NOTE]
>
>如需Adobe Commerce Optimizer其他可用整合的概觀，請參閱[整合](../integrations/integrations-overview.md)。
