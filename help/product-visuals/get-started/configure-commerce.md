...
description: 瞭解如何在Adobe Commerce執行個體上安裝適用於Adobe Commerce的AEM Assets整合擴充功能。 若要搭配Adobe Commerce使用產品視覺效果，此擴充功能為必要專案。
feature: CMS, Media
...
在具有AEM Assets 2.4.5+版的Adobe Commerce執行個體上安裝產品視覺效果適用的最新版Adobe Commerce整合擴充功能(`aem-assets-integration`)。 擴充功能會從[repo.magento.com](https://repo.magento.com/admin/dashboard)存放庫以撰寫器中繼資料的形式傳送。
