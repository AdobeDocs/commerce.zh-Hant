...
| [付款](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/payments/payments) | [Adobe Commerce的付款服務](../payment-services/guide-overview.md) | 可用 | 整合的支付服務，可促進安全且有效率的交易。 |
