...
feature_v2: id: e8818fe6-9c8b-4bc0-9ef8-377a10b7bc75id: f08fa0de-a550-4acd-b570-f81cf1d03aaf
...
>[!IMPORTANT]
>
>組態設定不會自動匯入。 開始資料移轉程式之前，請在[!DNL Commerce Admin]中記下目前的目錄組態設定。 然後在目標[!DNL Adobe Commerce as a Cloud Service]環境中實作相同的設定。
