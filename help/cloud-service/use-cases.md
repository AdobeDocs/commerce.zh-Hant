...
1. 在Commerce管理員中，瀏覽至&#x200B;[!UICONTROL **設定**] > [!UICONTROL **付款方法**]。
...
1. 開啟檔案製作。 瀏覽至`https://da.live/#/<GitHub User Name>/<Repository Name>/main/da/index.md`。
...
1. 在店面的[檔案製作]檢視中，選取索引頁面，然後按一下[複製]。[!UICONTROL ****]
