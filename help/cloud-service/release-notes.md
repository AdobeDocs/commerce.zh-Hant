...
如需詳細資訊，包括GraphQL變動和REST端點，請參閱[店面相容性B2B封裝變更記錄檔](https://experienceleague.adobe.com/developer/commerce/storefront/releases/changelog/)，並檢視&#x200B;**店面相容性B2B封裝v1.0.24**&#x200B;區段。
