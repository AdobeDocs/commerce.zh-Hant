...
>[!NOTE]
>
>If you are using Adobe Commerce on-premises or Adobe Commerce on cloud infrastructure, see the [Adobe Commerce release notes](https://experienceleague.adobe.com/zh-hant/docs/commerce-operations/release/notes/overview).

## April 2026 - release #2 {#latest}

[!BADGE Production]{type=Neutral tooltip="列出的專案目前可在生產環境中使用。"}
...
If you have [[!DNL Payment Services]](https://experienceleague.adobe.com/zh-hant/docs/commerce/payment-services/get-started/production) enabled, the [Dashboard UI](../payment-services/payments-home.md) is now available in the [!DNL Commerce Admin], providing access to the [Transactions report](../payment-services/reporting.md#transactions-report-view) for viewing and managing payment transactions. <!-- PAY-6510 -->
