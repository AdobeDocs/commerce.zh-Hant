...
1. **設定[!DNL Adobe Commerce Optimizer]目錄檢視與原則**
   ...
   在[!DNL Adobe Commerce Optimizer] UI中建立目錄檢視和原則。 請注意，價格簿是從Adobe Commerce客戶群組自動建立的。 如需指示，請參閱[Commerce Optimizer使用手冊](../optimizer/setup/catalog-view.md)中的[目錄檢視](../optimizer/setup/catalog-view.md)和&#x200B;*原則*&#x200B;檔案。
