...
如果您不是授權擁有者，則必須從擁有您商店的Commerce授權的人或團隊取得Commerce API金鑰。

>[!NOTE]
>
>API金鑰僅能由授權擁有者產生。 沒有可允許其他使用者產生存取權的共用存取權功能。
...
| 服務 | 可用性 |
| ---|--- |
| 由Adobe AI提供技術支援的[[!DNL Product Recommendations]](/help/product-recommendations/overview.md) | Adobe Commerce |
| 由Adobe AI提供技術支援的[[!DNL Live Search]](/help/live-search/overview.md) | Adobe Commerce |
...
>[!NOTE]
>
> 如果您在&#x200B;**[!UICONTROL Commerce Services Connector]**&#x200B;設定中沒有看到[!DNL Commerce]區段，則必須為所需的[!DNL Commerce]服務[[!DNL Commerce] 安裝](#availableservices)模組。
