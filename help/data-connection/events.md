...
>[!NOTE]
>
>所有行為事件都包含[`identityMap`](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/xdm/field-groups/profile/identitymap)欄位，其中包括購物者的電子郵件地址（可用時）和ECID。
...
B2B事件包含[請購單清單](https://experienceleague.adobe.com/zh-hant/docs/commerce-admin/b2b/requisition-lists/requisition-lists)資訊，例如，請購單清單是否已建立、新增或刪除。 透過追蹤請購單清單的特定事件，您可以檢視客戶經常購買哪些產品，並根據該資料建立行銷活動。
