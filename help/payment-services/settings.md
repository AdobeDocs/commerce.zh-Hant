...
只有當您透過Paypal完成[Apple Pay自助註冊](https://developer.paypal.com/docs/checkout/apm/apple-pay/#register-your-live-domain)，然後[為商店設定Apple Pay](settings.md/#payment-buttons)時，才能使用Apple Pay。
