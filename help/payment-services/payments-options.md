...
>[!NOTE]
>
>  Apple Pay網域驗證憑證已納入支付服務程式碼中。 確認路徑`/.well-known/apple-developer-merchantid-domain-association`傳回200回應代碼。 如需[Apple Pay網域驗證](https://developer.paypal.com/docs/checkout/apm/apple-pay/#download-and-host-sandbox-domain-association-file)憑證的詳細資訊，請參閱有關與Apple Pay整合的&#x200B;**PayPal開發人員檔案**。
...
您可以在存放區組態或[!UICONTROL PayPal payment buttons]首頁中設定[!DNL Payment Services]。
...
瞭解如何更新[!DNL Pay Later]設定[設定，以停用或啟用](configure-admin.md#paypal-payment-buttons)訊息。

##### 選填。 設定稍後付費訊息

**設定**&#x200B;稍後付款[的訊息](configure-admin.md#paypal-payment-buttons)可讓商家修改此付款選項的預設樣式。 如果您在&#x200B;**[!UICONTROL Display Pay Later Message]**&#x200B;設定`Yes`設定中將[設為](configure-admin.md#paypal-payment-buttons)，則會顯示&#x200B;**[!UICONTROL Configure Messaging]**&#x200B;強制回應按鈕，讓您能夠設定&#x200B;**[!UICONTROL PayPal Pay Later messaging]**&#x200B;的樣式。
...
1. 確定您的存放區在生產模式[中為](configure-admin.md#general-configuration)。
1. [在[設定]中設定所需的PayPal付款按鈕](configure-admin.md#paypal-payment-buttons)。
1. 開啟&#x200B;_區段中的_&#x200B;關閉&#x200B;**[[!UICONTROL Show PayPal Credit and Debit card button]](configure-admin.md#paypal-payment-buttons)** _[!UICONTROL Payment buttons]_&#x200B;選項。

要&#x200B;**擷取您現有信用卡提供者的付款&#x200B;_和_ PayPal付款按鈕**：

1. 確定您的存放區在生產模式[中為](configure-admin.md#general-configuration)。
1. [設定所需的PayPal付款按鈕](configure-admin.md#paypal-payment-buttons)。
1. 開啟&#x200B;_區段中的_&#x200B;關閉&#x200B;**[[!UICONTROL PayPal Show Credit and Debit card button]](configure-admin.md#paypal-payment-buttons)** _[!UICONTROL Payment buttons]_&#x200B;選項。
1. 開啟&#x200B;_區段中的_&#x200B;關閉&#x200B;**[[!UICONTROL Show on checkout page]](configure-admin.md#credit-card-fields)** _[!UICONTROL Credit card fields]_&#x200B;選項，並使用您的[現有信用卡提供者帳戶](https://experienceleague.adobe.com/docs/commerce-admin/stores-sales/payments/payments.html#payments)。
