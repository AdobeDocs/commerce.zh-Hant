...
1. 啟用並排程`sync_order_payment_status` cron工作，以便自動擷取狀態更新。 請參閱[設定cron工作](https://experienceleague.adobe.com/zh-hant/docs/commerce-operations/configuration-guide/cli/configure-cron-jobs)。
...
1. 在&#x200B;_管理員_&#x200B;側邊欄上，前往&#x200B;**[!UICONTROL Sales]** > **[!UICONTROL [!DNL Payment Services]]** > _[!UICONTROL Orders]_>**[!UICONTROL View Report]**。
1. 如果您想要檢視過去30天以外時間範圍的狀態，請[自訂您狀態的日期範圍時間範圍](#customize-order-dates-timeframe)。
