...
1. 啟用並排程`sync_order_payment_status` cron工作，以便自動擷取狀態更新。 請參閱[設定cron工作](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/cli/configure-cron-jobs)。
