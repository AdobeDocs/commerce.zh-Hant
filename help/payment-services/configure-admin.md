...
在舊版中，網站層級PayPal帳戶對應通常要求您[聯絡支援人員](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide.html#Solution)或您的Adobe代表。 當您符合下列必要條件時，請使用&#x200B;**[!UICONTROL Connect different account]**&#x200B;動作。
