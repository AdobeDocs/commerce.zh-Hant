...
description: 透過完成您的Adobe Commerce部署的入門，使用PaaS、內部部署和SaaS的沙箱和生產步驟，將您的執行個體連線到 [!DNL Payment Services] 。
role: User
level: Intermediate
...
>[!MORELIKETHIS]
>
> * [疑難排解 [!DNL Payment Services] 安裝](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26826)
> * [未驗證PayPal沙箱帳戶](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26836)
> * [延遲 [!DNL Payment Services] 報告資料](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26837)
> * 在沙箱環境中處理付款時，[測試信用卡無法透過PayPal](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26825)
