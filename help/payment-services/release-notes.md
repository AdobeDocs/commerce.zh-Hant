...
![新增](../assets/new.svg)<!-- PAY-6227 -->使用PayPal結帳時，[!DNL Payment Services]會略過訂單確認快顯視窗，以加快購買程式。 這是由[伺服器端送貨回呼](payments-options.md#server-side-shipping-callback)所啟用，它直接在PayPal檢閱頁面中計算送貨與總計。
