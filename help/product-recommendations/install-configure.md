...
[!DNL Product Recommendations]的Fastly影像最佳化支援是選用的模組，需另行安裝。 此模組將[Fastly影像最佳化](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/cdn/fastly)引數套用至[!DNL Product Recommendations]個影像URL。 若要安裝，請執行以下命令：
