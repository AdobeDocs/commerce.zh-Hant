...
| solution-icon | Displays solution icon next to solution title. 尚未實作 |
| getting-started-url | helpx快速入門頁面連結 |
| tutorials-url | 教學課程影片（helpx或KT教學課程其中之一）的連結 |
| mini-toc-levels | Determines the number of heading levels that appear in right rail. 預設為2 |
